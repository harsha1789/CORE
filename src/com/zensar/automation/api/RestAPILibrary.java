 ...
 */
	 ...
	 * @return
	 */
	public boolean createRegMarketUserInAxiom_old( String userName,String currencyIsoCode,String regMarket ,int marketTypeID, int productId  )
	{
		boolean isUsrCreated=false;
		String responseStatus=null;
		Response response=null;
	 ...
	 * @author rk61073
	 */
	public boolean createRegMarketUserInAxiom_old(String userName, String currencyIsoCode, String regMarket,
			String marketTypeID , String productId) 
	{
		boolean isUsrCreated=false;
		String responseStatus=null;
		Response response=null;
		...
		try{
			...
			RequestBody body = RequestBody.create(mediaType, "{\"Username\":\""+userName+"\","
					+ "\"Password\":\""+password+"\","
					+ "\"MarketTypeId\":"+marketTypeID.replace(".0", "")+","
					+ "\"ServerId\":"+productId.replace(".0", "")+","
					+ "\"UserTypeId\":0,"
					+ "\"currencyIsoCode\":\""+currencyIsoCode+"\","
					+ "\"Country\":\""+regMarket+"\","
					+ "\"NumberOfAccounts\":1}");
			if (okHttpClientclient != null) {
				...
				System.out.println("Create user for Reg Market :  "+response.isSuccessful());
