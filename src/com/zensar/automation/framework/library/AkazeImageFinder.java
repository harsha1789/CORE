...
public class AkazeImageFinder{
	...
	public Point[] findImage(String objectFilenameNopng, String
		...
		Mat imgScene = Imgcodecs.imread(sceneFilename, Imgcodecs.CV_LOAD_IMAGE_UNCHANGED);
		...
		if (resizeFactor > 1) {
			...
			imgScene = Imgcodecs.imread(sceneFilename, Imgcodecs.CV_LOAD_IMAGE_UNCHANGED);
