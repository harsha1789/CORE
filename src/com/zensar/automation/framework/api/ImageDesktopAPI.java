...
//	String assetsPath = null;
	...
	*/	
	...
	public boolean isImageAppears(Image image) {
		...
		try {
		//	HT67091//Needed for selenium 4   :the wait will continue for a maximum of 30 seconds, checking for the desired condition every 1 second. If the condition is met before the timeout, the wait will end. If the timeout is reached and the condition is still not met, the wait will also end, allowing the test to proceed.
	...
	// added below 2 methods for the demo only, please do not use
	public String getTextCreditAmount(Image image) 
	{
		String respString = null;
		File fp=new File("D:\\ImageComparision\\BreakAwayLuckyWilds\\Desktop\\Credits.png");
		try 
		{
			ZAFOCR zafocr = new ZAFOCR();
