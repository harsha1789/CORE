...
public class MobileDriverTest {
	...
	public static void main (String []args) throws MalformedURLException, URISyntaxException{
		//AppiumDriver<WebElement> webDriver=null; Older sel 3.141.59
		AppiumDriver webDriver=null; //Selenium 4 change
...
*/
		//	webDriver = new AndroidDriver<>(new URL(appiumServiceUrl), capabilities);//Sel 3.141.50 
			webDriver = new AndroidDriver(new URL(appiumServiceUrl), capabilities);//Sel 4 
		//	webDriver = new IOSDriver<>(new URL(appiumServiceUrl), capabilities);
			...
			//WebDriverWait wait= new WebDriverWait(webDriver, 60);  //Supported in sel 3.141.59
			
			//Web driver wait --Introduce fluent wait instead of web driver wait 
			//Supported in sel 4
			FluentWait<AppiumDriver> wait = new FluentWait<>(webDriver)
